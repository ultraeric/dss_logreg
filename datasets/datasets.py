...
def process_data():
	file_read = open('./datasets/breast-cancer-wisconsin.data', 'r')
	file_write = open('./datasets/breast-cancer-wisconsin.json', 'w+')
...
def cancer_data_gen():
	file_read = open('./datasets/breast-cancer-wisconsin.json', 'r')
	line = file_read.readline()
	data_array = []
	while line:
